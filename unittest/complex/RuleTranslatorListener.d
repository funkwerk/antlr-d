...
public interface RuleTranslatorListener : ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link RuleTranslatorParser#funct_name}.
     * @param ctx the parse tree
     */
    void enterFunct_name(RuleTranslatorParser.Funct_nameContext ctx);
    /**
     * Exit a parse tree produced by {@link RuleTranslatorParser#funct_name}.
     * @param ctx the parse tree
     */
    ...
    /**
     * Enter a parse tree produced by {@link RuleTranslatorParser#dotted_name_first_part}.
     * @param ctx the parse tree
     */
    void enterDotted_name_first_part(RuleTranslatorParser.Dotted_name_first_partContext ctx);
    /**
     * Exit a parse tree produced by {@link RuleTranslatorParser#dotted_name_first_part}.
     * @param ctx the parse tree
     */
    void exitDotted_name_first_part(RuleTranslatorParser.Dotted_name_first_partContext ctx);
    /**
     * Enter a parse tree produced by {@link RuleTranslatorParser#dotted_name_part}.
     * @param ctx the parse tree
     */
    void enterDotted_name_part(RuleTranslatorParser.Dotted_name_partContext ctx);
    /**
     * Exit a parse tree produced by {@link RuleTranslatorParser#dotted_name_part}.
     * @param ctx the parse tree
     */
    void exitDotted_name_part(RuleTranslatorParser.Dotted_name_partContext ctx);
    /**
     * Enter a parse tree produced by {@link RuleTranslatorParser#first_part_of_dotted_name}.
     * @param ctx the parse tree
     */
    void enterFirst_part_of_dotted_name(RuleTranslatorParser.First_part_of_dotted_nameContext ctx);
    /**
     * Exit a parse tree produced by {@link RuleTranslatorParser#first_part_of_dotted_name}.
     * @param ctx the parse tree
     */
