...
class Test
{
    ...
    import antlr.v4.runtime.tree.RuleNode: RuleNode;
    ...
    unittest
    {
        ...
        lexer.getRuleNames.should.equal(["T__0", "T__1", "T__2", "T__3", "T__4",
                                         "T__5", "NEWLINE", "INT"]);
        ...
        import antlr.v4.runtime.tree.TerminalNode : TerminalNode;
    ...
    unittest
    {
        ...
        progContext.children[1].classinfo.should.equal(TerminalNode.classinfo);
        (cast(RuleContext) progContext).toStringTree(parser)
            .should.equal("([] ([4] [@0,0:0='(',<5>,1:0] ([15 4] [@1,1:3='100',<8>,1:1]) "
                          ~ "[@2,4:4=')',<6>,1:4]) [@3,5:5='\\n',<7>,1:5])[\"prog\", \"expr\"]");
    }
    ...
    unittest
    {
        ...
        progContext.children.length.should.equal(2);
        (cast(RuleContext) progContext).toStringTree(parser)
            .should.equal("([] ([4] ([2 4] [@0,0:2='100',<8>,1:0]) "
